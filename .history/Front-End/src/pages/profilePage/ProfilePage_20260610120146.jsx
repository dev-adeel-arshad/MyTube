        ...
        <div className="profile-page">
            ...
            <div className="channel-content">
                ...
                {!isOwn && activeTab === "home" && (
                    <div>
                        <h3>All Videos and Shorts</h3>
                        {combinedItems.length === 0 ? (
                            renderEmptyState(
                                "No uploads yet",
                                "This creator has not uploaded any videos or shorts so far.",
                                null,
                                null
                            )
                        ) : (
                    ...
                    <div className="profile-home-sections">
                        ...
                        {userShorts.length > 0 && (
                            <section className="profile-home-section">
                                <div className="profile-section-header">
                                    <h3>Shorts</h3>
                                    <button className="view-all-sm" onClick={() => navigate("/shorts")}>View all</button>
                                </div>
                                <div className="shorts-home-row">
                                    {userShorts.slice(0, 8).map((short) => (
                                        <div
                                            className="short-home-card"
                                            key={short._id}
                                            onClick={() => navigate(`/shorts/${short._id}`)}
                                        >
                                            <div className="short-home-thumb">
                                                <img src={short.thumbnail || "/default-thumb.svg"} alt={short.title} />
                                                <span className="short-badge">Short</span>
                                            </div>
                                            <p className="short-home-title">{short.title || "Untitled"}</p>
                                        </div>
                                    ))}
                                </div>
                            </section>
                ...
                {activeTab === "shorts" && (
                    <div>
                        ...
                        {userShorts.length === 0 ? (
                            renderEmptyState(
                                "No shorts yet",
                                "Create a short to reach new viewers quickly.",
                                creatorCta?.label,
                                creatorCta?.action
                            )
                        ) : (
                            <div className="channel-grid">
                                {userShorts.map((short) => (
                                    <div className="video-card" key={short._id} onClick={() => navigate(`/shorts/${short._id}`)}>
                                        <img className="video-thumb" src={short.thumbnail || "/default-thumb.svg"} alt="thumb" />
                                        <div className="video-title">{short.title || "Untitled"}</div>
                                    </div>
                                ))}
                            </div>
                        )}
